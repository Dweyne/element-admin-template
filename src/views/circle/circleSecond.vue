 ...
 <el-card class="box-card">
   ...
   <el-form :model="queryParams" ref="queryForm" :inline="true" label-width="68px">
    ...
    <el-table v-loading="loading" :data="priceList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="一级圈子id" width="130" align="center" prop="pid" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" align="center">
      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="二级圈子名称" prop="circleName">
          <el-input v-model="form.circleName" placeholder="" />
        </el-form-item>
        <el-form-item label="一级圈子" prop="pid">
          <el-select v-model="form.pid" placeholder="请选择一级圈子">
              <el-option
                v-for="item in firstCircleList"
                :key="item.id"
...
export default {
  ...
  methods: {
    ...
    getFirstCircle() {
      ...
      circleList(params).then(response => {
        this.firstCircleList = response.data.records;
        this.loading = false;
      });
    },
    // 取消按钮
