<template>
 ...
 <el-card class="box-card">
   ...
   <el-form :model="queryParams" ref="queryForm" :inline="true" label-width="68px">
     <el-form-item label="悬赏id" prop="id">
       <el-input v-model="queryParams.id" placeholder="请输入悬赏id" clearable size="small" @keyup.enter.native="handleQuery" />
     </el-form-item>
     <el-form-item label="">
    ...
    <el-table v-loading="loading" :data="priceList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="奖励金额" width="130" align="center" prop="rewardAmount" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" align="center">
      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="奖励金额" prop="rewardAmount">
          <el-input v-model="form.rewardAmount" placeholder="" disabled="disabled"/>
        </el-form-item>
...
<script>
import { rewardList,rewardInfo,rewardDel } from "@/api/reward/reward";
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      rewardList(this.queryParams).then(response => {
    ...
    submitForm: function() {
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (this.form.id != 0) {
            rewardUpdate(this.form).then(response => {
            ...
            rewardAdd(this.form).then(response => {
              if (response.code === 200) {
